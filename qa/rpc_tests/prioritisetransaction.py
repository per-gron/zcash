...
class PrioritiseTransactionTest (BitcoinTestFramework):
    ...
    def setup_network(self, split=False):
        ...
        self.nodes.append(start_node(0, self.options.testbinary, self.options.tmpdir, ["-blockprioritysize=7000", "-blockmaxsize=11000", "-maxorphantx=1000", "-relaypriority=true", "-printpriority=1"]))
        self.nodes.append(start_node(1, self.options.testbinary, self.options.tmpdir, ["-blockprioritysize=7000", "-blockmaxsize=11000", "-maxorphantx=1000", "-relaypriority=true", "-printpriority=1"]))
