...
class MerkleBlockTest(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        self.nodes.append(start_node(0, self.options.testbinary, self.options.tmpdir, ["-debug"]))
        self.nodes.append(start_node(1, self.options.testbinary, self.options.tmpdir, ["-debug"]))
        # Nodes 2/3 are used for testing
        self.nodes.append(start_node(2, self.options.testbinary, self.options.tmpdir, ["-debug"]))
        self.nodes.append(start_node(3, self.options.testbinary, self.options.tmpdir, ["-debug", "-txindex"]))
