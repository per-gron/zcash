...
##
## Bazel BUILD file for OpenSSL
##
## This file has been autogenerated for ZCash using the
## generate_openssl_bazel.py script. Do not edit manually. When changing openssl
## versions, re-run this script and copy the BUILD.bazel to this folder.
##
## {- join("\n## ", @autowarntext) -}
{-
     use Text::ParseWords ();
